...
def main(): 
    ...
    while juego == "si":
        ...
        if estado_de_mascota_2 == estados["atributos"]["mejora"] and estado_de_mascota_1 == estados["atributos"]["mejora"]:
            print(f"{nombre_mascota} esta jugando con {nombre_mascota_2}")
